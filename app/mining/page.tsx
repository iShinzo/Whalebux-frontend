...
export default function MiningPage() {
  ...
  const { experience = 0, firstName = "Miner" } = useUserStore() // Default values to prevent null/undefined issues
  const { isMining } = useMiningStore()

  // Memoize the level calculation for performance optimization
